...
public class ApiUpdateFeatureTest extends BaseIntegrationTest {
    ...
    public void shouldEnableFeature() {
        ...
        // when
        ResponseEntity<FeatureDto> response = adminClient.updateFeature(FEATURE_1, true);
    ...
    public void shouldDisableFeature() {
        ...
        // when
        ResponseEntity<FeatureDto> response = adminClient.updateFeature(FEATURE_1, false);
    ...
    public void shouldAllowOnlyAdmin() {
        ...
        // when
        ResponseEntity<FeatureDto> response = userClient.updateFeature(FEATURE_1, true);
